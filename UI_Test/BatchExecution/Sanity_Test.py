...
from UI_Test.UnitTestExample.UnitTestassertion.Verifyuserpresence_assert import OrangeHRM_Login_Logout

search_text = unittest.TestLoader().loadTestsFromTestCase(OrangeHRM_Login_Logout)
