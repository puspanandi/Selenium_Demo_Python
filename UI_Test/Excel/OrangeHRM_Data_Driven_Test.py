...
from UI_Test.Excel import XLUtils
...
for r in range(2,rows+1):
    ...
    try:
        if browser.find_element_by_link_text("Dashboard").is_displayed():
            ...
            XLUtils.writeData(path,'SignIn',r,3,"Test Successful")
            XLUtils.writeData(path, 'SignIn', r, 4, Act_Res)
            time.sleep(4)
        ...
        XLUtils.writeData(path, 'SignIn', r, 3,"Test Un-Successful")
        XLUtils.writeData(path, 'SignIn', r, 4, Act_msg)
browser.quit()
